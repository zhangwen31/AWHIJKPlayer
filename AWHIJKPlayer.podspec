...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHIJKPlayer.git"
  ...
  # s.authors            = { "王恒" => "1066026709@qq.com" }
   s.social_media_url   = "https://github.com/zhangwen31/AWHIJKPlayer"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHIJKPlayer.git", :tag => "#{s.version}" }
